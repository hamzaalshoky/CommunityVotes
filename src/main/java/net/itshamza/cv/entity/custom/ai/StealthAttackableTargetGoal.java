package net.itshamza.cv.entity.custom.ai;
...
public class StealthAttackableTargetGoal extends NearestAttackableTargetGoal {
    MushroomSpiderEntity jag;

    public StealthAttackableTargetGoal(Mob p_26060_, Class p_26061_, boolean p_26062_, MushroomSpiderEntity jag) {
